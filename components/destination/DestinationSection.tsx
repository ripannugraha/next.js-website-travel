    ...
    <section className="py-20 bg-gray-50">
      <div className="max-w-[1440px] mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <DestinationCard
            image="/images/destination-1.jpg" // ← PLACEHOLDER
          ...
          <DestinationCard
            ...
            rating={4.6}
            description="Rasakan ketenangan dan keagungan candi Buddha terbesar di dunia dengan panorama alam yang indah."
            price="Rp. 2.500.000"
          />
          ...
          <DestinationCard
            ...
            location="Bali"
            rating={4.8}
            description="Destinasi favorit dengan pantai eksotis, tebing ikonik, dan laut biru jernih khas Bali."
            price="Rp. 3.000.000"
          />
          ...
          <DestinationCard
            ...
            location="Jawa Timur"
            rating={4.7}
            description="Saksikan keindahan matahari terbit dengan latar pegunungan dan lautan pasir yang menakjubkan."
            price="Rp. 1.900.000"
          />
